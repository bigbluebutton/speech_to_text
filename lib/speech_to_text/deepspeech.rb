...
module SpeechToText
  module MozillaDeepspeechS2T # rubocop:disable Style/Documentation
    ...
    def self.generate_transcript(audio, json_file, model_path)
      ...
      deepspeech_command = "#{model_path}/deepspeech --model #{model_path}/deepspeech-0.6.1-models/output_graph.pbmm --lm #{model_path}/deepspeech-0.6.1-models/lm.binary --trie #{model_path}/deepspeech-0.6.1-models/trie --audio #{audio} > #{json_file}"
